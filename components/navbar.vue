...
<template>
    ...
    <aside class="md:opacity-0 md:pointer-events-none fixed top-0 left-0 h-[98dvh] w-full z-20 bg-background pt-[60px] flex flex-col pb-10" :class="{'pointer-events-none opacity-0': !showMobileNav}">
